...
So from the start they have set themselves up with limitations so that only 3.2 level oracle systems will be possible for them. You can read about security levels here: basics/trust_theory.md
...
You can read about Amoveo's oracle design here: design/oracle.md
