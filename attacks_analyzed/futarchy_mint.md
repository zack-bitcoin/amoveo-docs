...
ROI: a key metric to understand mint-futarchy is the return on investment. If the ROI is 2, that means we minted coins worth $X, and caused the market cap to increase by $(2*X).
